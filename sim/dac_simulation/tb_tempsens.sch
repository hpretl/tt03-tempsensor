...
.param dacval0=((daccode-dacval5*32/1.8-dacval4*16/1.8-dacval3*8/1.8-dacval2*4/1.8-dacval1*2/1.8)>0)*1.8
...
print v(x1.temp1.dac_vout_notouch_) > res.txt
...
C {devices/vsource.sym} 520 -260 0 0 {name=Vdac0 value="dacval0 pwl(0 1.8 10u 1.8 10.001u 0 30u 0 30.001u dacval0)"}
C {devices/vsource.sym} 460 -260 0 0 {name=Vdac1 value="dacval1 pwl(0 1.8 10u 1.8 10.001u 0 30u 0 30.001u dacval1)"}
C {devices/vsource.sym} 400 -260 0 0 {name=Vdac2 value="dacval2 pwl(0 1.8 10u 1.8 10.001u 0 30u 0 30.001u dacval2)"}
C {devices/vsource.sym} 340 -260 0 0 {name=Vdac3 value="dacval3 pwl(0 1.8 10u 1.8 10.001u 0 30u 0 30.001u dacval3)"}
C {devices/vsource.sym} 280 -260 0 0 {name=Vdac4 value="dacval4 pwl(0 1.8 10u 1.8 10.001u 0 30u 0 30.001u dacval4)"}
C {devices/vsource.sym} 220 -260 0 0 {name=Vdac5 value="dacval5 pwl(0 1.8 10u 1.8 10.001u 0 30u 0 30.001u dacval5)"}
...
C {devices/launcher.sym} 1300 -160 0 0 {name=h2 
descr="Simulate" 
tclcommand="xschem save; xschem netlist; xschem simulate"}
C {devices/launcher.sym} 1300 -120 0 0 {name=h15
descr="Annotate OP" 
